        ...
        <div class="row">
            <div class="col-md-6 d-flex align-items-center">
                <p class="mb-0 phone pl-md-2">
                    <a href="#" class="mr-2"><span class="fa fa-phone mr-1"></span> +593 90-876-6763</a>
                    <a href="#"><span class="fa fa-paper-plane mr-1"></span> petclinica@email.com</a>
                </p>
            </div>
        ...
        <div class="row d-flex no-gutters">
            <div class="col-md-5 d-flex">
                <div class="img img-video d-flex align-self-stretch align-items-center justify-content-center justify-content-md-center mb-4 mb-sm-0"
                     style="background-image:url(img/about-1.jpg);">
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="heading-section mb-5 mt-5 mt-lg-0">
                    ...
                    <p>Aqui encontraras todas las preguntas mas frecuentes de todos los clientes</p>
                </div>
                <div id="accordion" class="myaccordion w-100" aria-multiselectable="true">
                    <div class="card">
                        ...
                        <div class="collapse show" id="collapseOne" role="tabpanel" aria-labelledby="headingOne">
                            <div class="card-body py-3 px-0">
                                <ol>
                                    <li>Enseñar comandos básicos como 'sentado' y 'quieto'</li>
                                    <li>Reforzar positivamente con premios y caricias</li>
                                    <li>Practicar sesiones cortas y frecuentes de entrenamiento</li>
                                    <li>Socializar al perro con otras personas y animales</li>
                                    <li>Ser constante y paciente durante el aprendizaje</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        <div class="card-header p-0" id="headingTwo" role="tab">
                            <h2 class="mb-0">
                                <button href="#collapseTwo"
                                    ...
                                    <p class="mb-0">¿Cómo cuidar de tus mascotas?</p>
                                    <i class="fa" aria-hidden="true"></i>
                                </button>
                            </h2>
                        </div>
                        <div class="collapse" id="collapseTwo" role="tabpanel" aria-labelledby="headingTwo">
                            <div class="card-body py-3 px-0">
                                <ol>
                                    <li>Proporciona una alimentación balanceada y adecuada para cada mascota</li>
                                    <li>Asegura agua fresca y limpia durante todo el día</li>
                                    <li>Mantén su espacio limpio y cómodo para que se sientan seguros</li>
                                    <li>Lleva a tus mascotas al veterinario para chequeos regulares</li>
                                    <li>Dedica tiempo diario para jugar y brindarles cariño</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        <div class="card-header p-0" id="headingThree" role="tab">
                            <h2 class="mb-0">
                                <button href="#collapseThree"
                                    ...
                                    <p class="mb-0">¿Cuál es el mejor aseo para tus mascotas?</p>
                                    <i class="fa" aria-hidden="true"></i>
                                </button>
                            </h2>
                        </div>
                        <div class="collapse" id="collapseThree" role="tabpanel" aria-labelledby="headingTwo">
                            <div class="card-body py-3 px-0">
                                <ol>
                                    <li>Brindar una alimentación nutritiva y adecuada a sus necesidades específicas</li>
                                    <li>Asegurar un ambiente limpio, seguro y confortable para su bienestar</li>
                                    <li>Proporcionar ejercicio diario y estimulación mental constante</li>
                                    <li>Realizar visitas regulares al veterinario para prevención y control de enfermedades</li>
                                    <li>Ofrecer mucho cariño, atención y socialización para su equilibrio emocional</li>
                    ...
                    <div class="card">
                        <div class="card-header p-0" id="headingFour" role="tab">
                            <h2 class="mb-0">
                                <button href="#collapseFour"
                                    ...
                                    <p class="mb-0">¿Cuáles son los requisitos para cuidar mascotas?</p>
                                    <i class="fa" aria-hidden="true"></i>
                                </button>
                            </h2>
                        </div>
                        <div class="collapse" id="collapseFour" role="tabpanel" aria-labelledby="headingTwo">
                            <div class="card-body py-3 px-0">
                                <ol><li>Alimentación balanceada y adecuada según su especie y edad</li>
                                    <li>Agua fresca y limpia disponible siempre</li>
                                    <li>Un espacio limpio, seguro y cómodo donde descansar</li>
                                    <li>Visitas periódicas al veterinario para mantener su salud</li>
                                    <li>Ejercicio y juego diario para su bienestar físico y mental</li>
                                    <li>Mucho cariño y socialización para su equilibrio emocional</li>
                                </ol>
                            </div>
                        </div>
                    </div>
    ...
    <div class="container">
        <div class="row justify-content-center pb-5 mb-3">
            <div class="col-md-7 heading-section text-center ftco-animate">
                <h2>Clientes felices y opiniones</h2>
            </div>
        </div>
...
<section class="ftco-section bg-light">
    <div class="container">
        <div class="row justify-content-center pb-5 mb-3">
            <div class="col-md-7 heading-section text-center ftco-animate">
                <h2>Paquetes Económicos</h2>
            </div>
        </div>
        <div class="row">
            <div class="col-md-4 ftco-animate">
                <div class="block-7">
                    <div class="img" style="background-image: url(img/pricing-1.jpg);"></div>
                    <div class="text-center p-4">
                        <span class="excerpt d-block">Personal</span>
                        <span class="price"><sup>$</sup> <span class="number">49</span> <sub>/mes</sub></span>

                        <ul class="pricing-text mb-5">
                            <li><span class="fa fa-check mr-2"></span>5 Paseos para perros</li>
                            <li><span class="fa fa-check mr-2"></span>3 Visitas al veterinario</li>
            ...
            <div class="col-md-4 ftco-animate">
                <div class="block-7">
                    <div class="img" style="background-image: url(img/pricing-2.jpg);"></div>
                    <div class="text-center p-4">
                        <span class="excerpt d-block">Negocio</span>
                        <span class="price"><sup>$</sup> <span class="number">79</span> <sub>/mes</sub></span>
            ...
            <div class="col-md-4 ftco-animate">
                <div class="block-7">
                    <div class="img" style="background-image: url(img/pricing-3.jpg);"></div>
                    <div class="text-center p-4">
                        <span class="excerpt d-block">Ultimate</span>
                        <span class="price"><sup>$</sup> <span class="number">109</span> <sub>/mes</sub></span>
            ...
            <div class="col-md-4 ftco-animate">
                <div class="work mb-4 img d-flex align-items-end"
                    ...
                    <div class="desc w-100 px-4">
                        <div class="text w-100 mb-3">
                            <span>Gato</span>
                            <h2><a href="work-single.html">Gato Esfinge</a></h2>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4 d-flex ftco-animate">
                <div class="blog-entry align-self-stretch">
                    ...
                    <div class="text p-4">
                        ...
                        <h3 class="heading"><a href="#">Ni el todopoderoso Pointing tiene control sobre los
                            textos ciegos</a></h3>
                    </div>
                </div>
            </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6 col-lg-3 mb-4 mb-md-0">
                ...
                <p>Un pequeño río llamado Duden fluye por su lugar y le suministra los regelialia necesarios.</p>
            ...
            <div class="col-md-6 col-lg-3 mb-4 mb-md-0">
                ...
                <div class="block-21 mb-4 d-flex">
                    ...
                    <div class="text">
                        <h3 class="heading"><a href="#">Ni el todopoderoso Pointing tiene control sobre</a></h3>
                        <div class="meta">
                            <div><a href="#"><span class="icon-calendar"></span> Abril 7, 2020</a></div>
        ...
        <div class="row mt-5">
            <div class="col-md-12 text-center">
                ...
                <p class="copyright">
                    ...
                    está hecha con <i class="fa fa-heart" aria-hidden="true"></i> por <a href=""
                                                                                         target="_blank">Clinica de mascotas</a>
                    <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                </p>
            </div>
        </div>
