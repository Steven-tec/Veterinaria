...
<html lang="en">
		  ...
		  <div class="row">
			  <div class="col-md-6 d-flex align-items-center">
				  <p class="mb-0 phone pl-md-2">
					  ...
					  <a href="#"><span class="fa fa-paper-plane mr-1"></span> tuemail@correo.com</a>
				  </p>
			  </div>
	  ...
	  <div class="container">
		  <div class="row no-gutters slider-text align-items-end">
			  <div class="col-md-9 ftco-animate pb-5">
				  <p class="breadcrumbs mb-2"><span class="mr-2"><a href="index.jsp">Inicio <i class="ion-ios-arrow-forward"></i></a></span> <span>Contacto <i class="ion-ios-arrow-forward"></i></span></p>
					  ...
					  <div class="row mb-5">
						  ...
						  <div class="col-md-3">
							  <div class="dbox w-100 text-center">
								  ...
								  <div class="text">
									  <p><span>Teléfono:</span> <a href="tel://1234567920">+593 0956 25654
									  </a></p>
								  </div>
							  </div>
						  </div>
						  <div class="col-md-3">
							  <div class="dbox w-100 text-center">
								  ...
								  <div class="text">
									  <p><span>Email:</span> <a href="mailto:info@yoursite.com">clinicademascotas@vet.com</a></p>
								  </div>
							  </div>
						  </div>
						  <div class="col-md-3">
  ...
  <!-- Quitamos este div del mapa -->
  <!-- <div id="map" class="map"></div> -->

  <footer class="footer">
	  <div class="container">
		  <div class="row">
			  <!-- Todo el contenido del footer permanece igual -->
		  </div>
		  <div class="row mt-5">
