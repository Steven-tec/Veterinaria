          ...
          <div class="row">
              <div class="col-md-6 d-flex align-items-center">
                  <p class="mb-0 phone pl-md-2">
                      ...
                      <a href="#"><span class="fa fa-paper-plane mr-1"></span> tuemail@email.com</a>
                  </p>
              </div>
      ...
      <div class="container">
          <div class="row no-gutters slider-text align-items-end">
              <div class="col-md-9 ftco-animate pb-5">
                  <p class="breadcrumbs mb-2"><span class="mr-2"><a href="index.jsp">Inicio <i class="ion-ios-arrow-forward"></i></a></span> <span>Servicios <i class="ion-ios-arrow-forward"></i></span></p>
      ...
      <div class="container">
          <div class="row mb-5 pb-5">
              ...
              <div class="col-md-4 d-flex align-self-stretch px-4 ftco-animate">
                  <div class="d-block services text-center">
                      <div class="icon d-flex align-items-center justify-content-center" style="font-size: 48px; color: #a13cc7;">
                          <i class="fas fa-walking"></i> <!-- icono de paseo -->
                      </div>
              ...
              <div class="col-md-4 d-flex align-self-stretch px-4 ftco-animate">
                  <div class="d-block services text-center">
                      <div class="icon d-flex align-items-center justify-content-center" style="font-size: 48px; color: #a13cc7;">
                          <i class="fas fa-dog"></i> <!-- icono mascota -->
                      </div>
                      <div class="media-body p-4">
              ...
              <div class="col-md-4 d-flex align-self-stretch px-4 ftco-animate">
                  <div class="d-block services text-center">
                      <div class="icon d-flex align-items-center justify-content-center" style="font-size: 48px; color: #a13cc7;">
                          <i class="fas fa-cut"></i> <!-- icono peluquería -->
                      </div>
                      <div class="media-body p-4">
          ...
          <div class="row mt-5 pt-4">
              ...
              <div class="col-md-4 d-flex align-self-stretch px-4 ftco-animate">
                  <div class="d-block services text-center">
                      <div class="icon d-flex align-items-center justify-content-center" style="font-size: 48px; color: #a13cc7;">
                          <i class="fas fa-chalkboard-teacher"></i> <!-- icono entrenamiento -->
                      </div>
                      <div class="media-body p-4">
              ...
              <div class="col-md-4 d-flex align-self-stretch px-4 ftco-animate">
                  <div class="d-block services text-center">
                      <div class="icon d-flex align-items-center justify-content-center" style="font-size: 48px; color: #a13cc7;">
                          <i class="fas fa-home"></i> <!-- icono guardería -->
                      </div>
                      <div class="media-body p-4">
              ...
              <div class="col-md-4 d-flex align-self-stretch px-4 ftco-animate">
                  <div class="d-block services text-center">
                      <div class="icon d-flex align-items-center justify-content-center" style="font-size: 48px; color: #a13cc7;">
                          <i class="fas fa-spa"></i> <!-- icono spa -->
                      </div>
                      <div class="media-body p-4">
      ...
      <div class="container">
          <div class="row">
              <div class="col-md-6 col-lg-3 mb-4 mb-md-0">
                  ...
                  <p>Un pequeño río llamado Duden pasa por su lugar y lo abastece con la regla necesaria.</p>
              ...
              <div class="col-md-6 col-lg-3 mb-4 mb-md-0">
                  ...
                  <ul class="list-unstyled">
                      <li><a href="index.jsp" class="py-1 d-block">Inicio</a></li>
                      <li><a href="about.jsp" class="py-1 d-block">Nosotros</a></li>
                      <li><a href="services.jsp" class="py-1 d-block">Servicios</a></li>
                      <li><a href="contact.jsp" class="py-1 d-block">Contacto</a></li>
                  </ul>
              </div>
              <div class="col-md-6 col-lg-3 mb-4 mb-md-0">
                  ...
                  <ul class="list-unstyled">
                      ...
                      <li><a href="#" class="py-1 d-block">Política de privacidad</a></li>
                      <li><a href="#" class="py-1 d-block">Centro de ayuda</a></li>
                  </ul>
              </div>
              <div class="col-md-6 col-lg-3 mb-4 mb-md-0">
                  ...
                  <div class="block-23 mb-3">
                      <ul>
                          <li><span class="icon fa fa-map-marker"></span><span class="text">123 Calle Principal, Ciudad, País</span></li>
                          <li><a href="#"><span class="icon fa fa-phone"></span><span class="text">+00 123 456 789</span></a></li>
                          <li><a href="#"><span class="icon fa fa-envelope"></span><span class="text">info@clinicamascotas.com</span></a></li>
                      </ul>
                  </div>
              </div>
          </div>
