        ...
        <div class="row">
            <div class="col-md-6 d-flex align-items-center">
                <p class="mb-0 phone pl-md-2">
                    ...
                    <a href="#"><span class="fa fa-paper-plane mr-1"></span> contacto@clinicaveterinaria.com</a>
                </p>
            </div>
    ...
    <div class="container">
        <div class="row no-gutters slider-text align-items-end">
            <div class="col-md-9 ftco-animate pb-5">
                <p class="breadcrumbs mb-2"><span class="mr-2"><a href="index.jsp">Inicio <i class="ion-ios-arrow-forward"></i></a></span> <span>Blog <i class="ion-ios-arrow-forward"></i></span></p>
                <h1 class="mb-0 bread">Blog de Noticias</h1>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="row d-flex">
            ...
            <div class="col-md-4 d-flex ftco-animate">
                <div class="blog-entry align-self-stretch">
                    <a href="blog-single.jsp" class="block-20 rounded" style="background-image: url('img/image_1.jpg');"></a>
                    <div class="text p-4">
                        <div class="meta mb-2">
                            <div><a href="#">12 de junio, 2025</a></div>
                            <div><a href="#">Dra. Martínez</a></div>
                            <div><a href="#" class="meta-chat"><span class="fa fa-comment"></span> 5</a></div>
                        </div>
                        <h3 class="heading"><a href="#">5 señales de alerta en la salud de tu mascota</a></h3>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4 d-flex ftco-animate">
                <div class="blog-entry align-self-stretch">
                    <a href="blog-single.jsp" class="block-20 rounded" style="background-image: url('img/image_2.jpg');"></a>
                    <div class="text p-4">
                        <div class="meta mb-2">
                            <div><a href="#">8 de junio, 2025</a></div>
                            <div><a href="#">Dr. Gómez</a></div>
                            <div><a href="#" class="meta-chat"><span class="fa fa-comment"></span> 3</a></div>
                        </div>
                        <h3 class="heading"><a href="#">Cómo mantener a tu perro activo y saludable</a></h3>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4 d-flex ftco-animate">
                <div class="blog-entry align-self-stretch">
                    <a href="blog-single.jsp" class="block-20 rounded" style="background-image: url('img/image_3.jpg');"></a>
                    <div class="text p-4">
                        <div class="meta mb-2">
                            <div><a href="#">5 de junio, 2025</a></div>
                            <div><a href="#">Dra. López</a></div>
                            <div><a href="#" class="meta-chat"><span class="fa fa-comment"></span> 7</a></div>
                        </div>
                        <h3 class="heading"><a href="#">Alimentación balanceada para gatos adultos</a></h3>
                    </div>
                </div>
            </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6 col-lg-3 mb-4 mb-md-0">
                ...
                <p>Contamos con los mejores especialistas para el cuidado de tu mascota. Atención personalizada y profesional.</p>
            ...
            <div class="col-md-6 col-lg-3 mb-4 mb-md-0">
                ...
                <div class="block-21 mb-4 d-flex">
                    ...
                    <div class="text">
                        <h3 class="heading"><a href="#">5 señales de alerta en la salud de tu mascota</a></h3>
                        <div class="meta">
                            <div><a href="#"><span class="icon-calendar"></span> 12 de junio, 2025</a></div>
                            <div><a href="#"><span class="icon-person"></span> Dra. Martínez</a></div>
                ...
                <div class="block-21 mb-4 d-flex">
                    ...
                    <div class="text">
                        <h3 class="heading"><a href="#">Cómo mantener a tu perro activo y saludable</a></h3>
                        <div class="meta">
                            <div><a href="#"><span class="icon-calendar"></span> 8 de junio, 2025</a></div>
                            <div><a href="#"><span class="icon-person"></span> Dr. Gómez</a></div>
