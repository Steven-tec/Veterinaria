...
<body>
	...
	<!-- END nav -->
	<section class="hero-wrap hero-wrap-2" style="background-image: url('img/bg_2.jpg');"
		data-stellar-background-ratio="0.5">
		<div class="overlay"></div>
		<div class="container">
			<div class="row no-gutters slider-text align-items-end">
				<div class="col-md-9 ftco-animate pb-5">
					<p class="breadcrumbs mb-2"><span class="mr-2"><a href="index.jsp">Inicio <i
									class="ion-ios-arrow-forward"></i></a></span> <span>Veterinarian <i
								class="ion-ios-arrow-forward"></i></span></p>
					<h1 class="mb-0 bread">Desarrolladores de Nuestra Pagina Web</h1>
				</div>
			</div>
		</div>
	</section>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-6 col-lg-3 ftco-animate">
					<div class="staff">
						<div class="img-wrap d-flex align-items-stretch">
							<div class="img align-self-stretch" style="background-image: url(img/maschcuhas.jpg);">
							</div>
						</div>
						<div class="text pt-3 px-3 pb-4 text-center">
							<h3>Ronny Basidas</h3>
							<span class="position mb-2">Developer Boss</span>
							<div class="faded">
								<p>Vuela alto Hermano.</p>
				...
				<div class="col-md-6 col-lg-3 ftco-animate">
					<div class="staff">
						<div class="img-wrap d-flex align-items-stretch">
							<div class="img align-self-stretch" style="background-image: url(img/Steven.jpg);">
							</div>
						</div>
						<div class="text pt-3 px-3 pb-4 text-center">
				...
				<div class="col-md-6 col-lg-3 ftco-animate">
					<div class="staff">
						<div class="img-wrap d-flex align-items-stretch">
							<div class="img align-self-stretch" style="background-image: url(img/alexis.jpg);">
							</div>
						</div>
						<div class="text pt-3 px-3 pb-4 text-center">
							<h3>Alexis Arcos</h3>
							<span class="position mb-2">Developer in Web </span>
							<div class="faded">
								<p>Dios no le dara veneno a susu mejores rosas.</p>
								<ul class="ftco-social text-center">
									<li class="ftco-animate"><a href="#"
											class="d-flex align-items-center justify-content-center"><span
												class="fa fa-twitter"></span></a></li>
				...
				<div class="col-md-6 col-lg-3 ftco-animate">
					<div class="staff">
						<div class="img-wrap d-flex align-items-stretch">
							<div class="img align-self-stretch" style="background-image: url(img/bully.jpg);">
							</div>
						</div>
						<div class="text pt-3 px-3 pb-4 text-center">
							<h3>Edison Proaño</h3>
							<span class="position mb-2">Developer en Full Stack</span>
							<div class="faded">
								<p>Especializado en Block Chain y boostrap.</p>
								<p>Mi madre me dio la vida pero Python las ganas de vivirla.</p>
								<ul class="ftco-social text-center">
									<li class="ftco-animate"><a href="#"
											class="d-flex align-items-center justify-content-center"><span
												class="fa fa-twitter"></span></a></li>
				...
				<div class="col-md-6 col-lg-3 ftco-animate">
					<div class="staff">
						<div class="img-wrap d-flex align-items-stretch">
							<div class="img align-self-stretch" style="background-image: url(img/shark.jpg);">
							</div>
						</div>
						<div class="text pt-3 px-3 pb-4 text-center">
							<h3>David Sharian</h3>
							<span class="position mb-2">Developer in Web </span>
							<div class="faded">
								<p>Puro trap argentino chaval.</p>
								<ul class="ftco-social text-center">
									<li class="ftco-animate"><a href="#"
											class="d-flex align-items-center justify-content-center"><span
												class="fa fa-twitter"></span></a></li>
				...
				<div class="col-md-6 col-lg-3 ftco-animate">
					<div class="staff">
						<div class="img-wrap d-flex align-items-stretch">
							<div class="img align-self-stretch" style="background-image: url(img/mongero.jpg);">
							</div>
						</div>
						<div class="text pt-3 px-3 pb-4 text-center">
							<h3>Roberto Carrillo</h3>
							<span class="position mb-2">Developer in Data Bsase</span>
							<div class="faded">
								<p>La cabra de Mongo DB.</p>
								<ul class="ftco-social text-center">
									<li class="ftco-animate"><a href="#"
											class="d-flex align-items-center justify-content-center"><span
												class="fa fa-twitter"></span></a></li>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-6 col-lg-3 mb-4 mb-md-0">
					...
					<p>Un pequeño río llamado Duden fluye por su lugar y les proporciona la regelia necesaria.</p>
				...
				<div class="col-md-6 col-lg-3 mb-4 mb-md-0">
					...
					<div class="block-21 mb-4 d-flex">
						...
						<div class="text">
							<h3 class="heading"><a href="#">Ni siquiera el todopoderoso Pointing tiene control sobre esto</a></h3>
							<div class="meta">
				...
				<div class="col-md-6 col-lg-3 mb-4 mb-md-0">
					...
					<div class="block-23 mb-3">
						<ul>
							<li><span class="icon fa fa-map"></span><span class="text">203 Calle Falsa, Mountain View, San Francisco, California, EE.UU.</span></li>
							<li><a href="#"><span class="icon fa fa-phone"></span><span class="text">+2 392 3929 210</span></a></li>
							<li><a href="#"><span class="icon fa fa-paper-plane"></span><span class="text">info@tudominio.com</span></a></li>
						</ul>
					</div>
				</div>
			</div>
			<div class="row mt-5">
				<div class="col-md-12 text-center">
					<p class="copyright">
						Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="fa fa-heart" aria-hidden="true"></i> by <a href="" target="_blank">Clinica de mascotas</a>
					</p>
				</div>
			</div>
		</div>
